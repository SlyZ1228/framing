...
def outcome_lin_weights():
       ...
       pitches = pitches.drop(columns=['bat_score', 'post_bat_score', 'balls', 'strikes'])
       ...
       pitches = pitches.drop(columns=['next_base_state', 'next_outs', 'outs_when_up', 'base_state']) # dont need these anymore
